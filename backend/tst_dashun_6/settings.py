"""
Django settings for tst_dashun_6 project.
...
ROOT_URLCONF = 'tst_dashun_6.urls'
...
WSGI_APPLICATION = 'tst_dashun_6.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "tst-dashun Support <support@tst-dashun-6.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_dashun_6 API",
    "DESCRIPTION": "API documentation for tst_dashun_6 App",
    "VERSION": "v1",
}
